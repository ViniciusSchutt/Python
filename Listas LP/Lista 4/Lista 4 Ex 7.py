#7=Crie uma função que receba três valores, 'a', 'b' e 'c', que são os coeficientes de uma
#equação do segundo grau e retorne o valor do delta, que é dado por 'b² - 4ac’.

import math

print("Esse programa calcula e retorna o valor de Delta de uma função do segundo grau. Por favor siga as instruções a seguir.")
