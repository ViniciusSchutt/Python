#4=Faça um programa que preencha uma matriz de ordem 3 x 5 de elementos inteiros.
...
print("A média dos elementos da matriz é: ", media) #d
print("O maior número da matriz é: ", maior)

print("Matriz original: ", matC)
print("Matriz final: ", altC) #e
