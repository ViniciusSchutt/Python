...
while x < 5:  # Enquanto o contador for menor que 5, para uma lista de 5 pessoas/vendedores
    ...
    css = vendas*0.15  # Calculo simples da comisão, css = comissão
    ...
    if vendas <= media:  # Se o valor das vendas de 1 vendedor for menor que a media,
        vendas_abaixo.append(vendas)  # ele entra para a lista daqueles que venderam abaixo da mediA
